#include <steeriously/components/PursuitComponent.hpp>
#include <steeriously/Steeriously.hpp>

using namespace steer;

steer::PursuitComponent::PursuitComponent(steer::BehaviorParameters* params)
: Agent(params)
...
steer::PursuitComponent::~PursuitComponent()
{

}

Vector2 steer::PursuitComponent::Calculate()
{
    ...
    if(isPursuitOn())
    {
        m_steeringForce = Pursuit(this, m_targetAgent) * getWeight();
    }

    return m_steeringForce;
}

bool steer::PursuitComponent::targetAcquired()
{
    return getPosition() == m_targetAgent->getPosition();
}

void steer::PursuitComponent::Update(float dt)
{
