...
/**
    \class Matrix2D
    \brief A class for 2D matrices and related operations.
**/
class Matrix2D
{
private:
	...
	**/
    ...
    /**
        * \fn	inline void  MatrixMultiply(Matrix &mIn);
        * \brief Multiplies internal matrix with a given matrix.
        * \param mIn - a steer::Matrix2D object.
	**/
...
public:
    ...
    /**
        * \fn Matrix2D();
        * \brief Default constructor, initializes matrix to the identity matrix.
    **/
    Matrix2D()
    {
    ...
    /**
        * \fn Identity();
        * \brief Creates an identity matrix internally.
    **/
    inline void Identity();

    //create a transformation matrix
    /**
        * \fn inline void Translate(float x, float y);
        * \brief Creates a transformation matrix internally.
    ...
    **/
    ...
    /**
        * \fn inline void Scale(float xScale, float yScale);
        * \brief Creates a scale matrix internally.
        * \param xScale - a plain old float.
        * \param yScale - a plain old float.
    **/
    inline void Scale(float xScale, float yScale);

    //create a rotation matrix
    /**
        * \fn inline void Rotate(float rotation);
        * \brief Creates a rotation matrix internally from a float.
        * \param rotation - a plain old float.
    **/
    inline void Rotate(float rotation);

    //create a rotation matrix from a fwd and side 2D vector
    /**
        * \fn inline void Rotate(const steer::Vector2 &fwd, const steer::Vector2 &side);
        * \brief Creates a rotation matrix internally from two vectors (steer::Vector2 - forward and side vectors most commonly, but not necessarily).
        * \param fwd - a steer::Vector2 of floats.
    ...
    **/
    ...
    /**
        * \fn inline void TransformVector2Ds(std::vector<steer::Vector2> &vPoints);
        * \brief Applies a transformation matrix to a std::vector of points.
        * \param vPoints - a std::vector of steer::Vector2 floats.
    **/
    ...
    /**
        * \fn inline void TransformVector2Ds(std::vector<steer::Vector2> &vPoints);
        * \brief Applies a transformation matrix to a point (steer::Vector2).
        * \param vPoint - a steer::Vector2 of floats.
    **/
